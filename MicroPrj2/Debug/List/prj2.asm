...
_step2_val:
	.DB  0x9,0x8,0xC,0x4,0x6,0x2,0x3,0x1
...
_0x0:
	.DB  0x46,0x61,0x74,0x65,0x6D,0x65,0x20,0x4D
	.DB  0x6F,0x73,0x61,0x76,0x69,0x6E,0x6A,0x64
	.DB  0x0,0x41,0x72,0x65,0x20,0x79,0x6F,0x75
	.DB  0x20,0x72,0x65,0x61,0x64,0x79,0x3F,0x0
	.DB  0x33,0x0,0x32,0x0,0x31,0x0,0x58,0x0
_0x2020003:
	.DB  0x80,0xC0
_0x2040060:
	.DB  0x1
...
; 0000 007C         PORTC = step2_val[step];
	MOVW R30,R6
	SUBI R30,LOW(-_step2_val*2)
	SBCI R31,HIGH(-_step2_val*2)
	LPM  R0,Z
	OUT  0x15,R0
; 0000 007D     }
	MOVW R30,R8
...
; 0000 0083             PORTC = step1_val[step];
	MOVW R30,R6
	SUBI R30,LOW(-_step1_val*2)
	SBCI R31,HIGH(-_step1_val*2)
	LPM  R0,Z
	OUT  0x15,R0
; 0000 0084         }
	MOVW R30,R8
